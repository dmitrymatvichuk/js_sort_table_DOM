...
headRow.addEventListener("click", (e)=>{
    ...
    switch(columnName){
        case "name":
            comparator = (a, b)=>a.cells[0].textContent.localeCompare(b.cells[0].textContent);
            break;
        case "position":
            comparator = (a, b)=>a.cells[1].textContent.localeCompare(b.cells[1].textContent);
            break;
        case "age":
            comparator = (a, b)=>+a.cells[2].textContent - +b.cells[2].textContent;
            break;
        case "salary":
            comparator = (a, b)=>{
                const aSalary = parseInt(a.cells[3].textContent.replace(/[^\d]/g, ""), 10);
                const bSalary = parseInt(b.cells[3].textContent.replace(/[^\d]/g, ""), 10);
